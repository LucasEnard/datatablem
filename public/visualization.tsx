      ...
      groups: [
        {
          ...
          dataTestSubj: 'lnsDatatableM_rows',
        ...
        },
        {
          ...
          supportsMoreColumns: true,
          filterOperations: (op) => op.isBucketed,
          dataTestSubj: 'lnsDatatableM_columns',
          enableDimensionEditor: true,
          hideGrouping: true,
          nestingOrder: 0,
        },
        {
          ...
          filterOperations: (op) => !op.isBucketed,
          required: true,
          dataTestSubj: 'lnsDatatableM_metrics',
          enableDimensionEditor: true,
        },
      ],
    };
              ...
              .map((column) => {
                ...
                return {
                  ...
                  chain: [
                    {
                      type: 'function',
                      function: 'lens_datatablem_column',
                      arguments: {
